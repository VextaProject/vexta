...
public:
    ...
    std::string operator()(const WitnessV2MLDSA& id) const
    {
    ...
    std::string operator()(const WitnessV3SLHDSA& id) const
    {
...
CTxDestination DecodeDestination(const std::string& str, const CChainParams& params, std::string& error_str)
{
    ...
    if (DecodeBase58Check(str, data, 21)) {
        // base58-encoded Vexta addresses.
