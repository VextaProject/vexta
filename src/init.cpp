...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-blockversion=<n>", "Override block version bits to test forking scenarios; mining algorithm bits are set by the selected PoW algorithm", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::BLOCK_CREATION);
