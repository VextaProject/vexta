...
/** Connect all vextad signal handlers */
void noui_connect();

/** Redirect all vextad signal handlers to LogPrintf. Used to check or suppress output during test runs that produce expected errors */
