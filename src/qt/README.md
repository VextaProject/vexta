...
- (Deprecated) Used to process BIP21 payment URI requests. Also handles URI-based application switching (e.g. when following a vexta:... link from a browser).
...
4. Enter `vexta-qt` as the Project Name and enter the absolute path to `src/qt` as Location
