...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, VextaUnits::SeparatorStyle separators=VextaUnits::SeparatorStyle::STANDARD) const;
