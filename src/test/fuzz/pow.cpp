...
FUZZ_TARGET_INIT(pow, initialize_pow)
{
    ...
    while (fuzzed_data_provider.remaining_bytes() > 0) {
        ...
        }
        {
            ...
            (void)CalculateLegacyNextWorkRequired(&current_block, fuzzed_data_provider.ConsumeIntegralInRange<int64_t>(0, std::numeric_limits<int64_t>::max()), consensus_params);
