 ...
 * for both vextad and vexta-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Vexta");
...
#define GIT_COMMIT_ID "42174383ab483afff87e6cd3a15a367142a269a7"
