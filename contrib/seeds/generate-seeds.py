...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef VEXTA_CHAINPARAMSSEEDS_H\n')
    g.write('#define VEXTA_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the Vexta network\n')
    ...
    g.write('#endif // VEXTA_CHAINPARAMSSEEDS_H\n')
